"""Configuration for the locomotion velocity-tracking environment with Go2 robot.
base on robot lab velocity env
diff: command without heading
      add curiculum for linear velocity
"""
...
from unitree_rl_lab.tasks.robotlab_locomotion import mdp
